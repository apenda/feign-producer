package com.apenda.core.aspect;
...
public class WebLogAspect {
     ...
     * 切点
     */
    @Pointcut("execution(public * com.apenda.core.controller..*.*(..))")
    public void webLog() {
        // Do nothing
    }
    ...
    public void doBefore(JoinPoint joinPoint) {
        ...
        logger.debug("Class Method   : {}.{}", declaringTypeName, name);
        // 请求 url
    ...
    public Object doAround(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        logger.debug("Response IP    : {}", localHost.getHostAddress());
        // 打印出参
